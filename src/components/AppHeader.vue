<template>
  <header class="app-header d-flex">
    <h1>Example task manager</h1>
    <button
        class="star"
        :class="{ selected: isSelected }"
        @click="toggleStar"
        title="Позначити дошку як важливу або зняти позначку"
        aria-label="Позначити дошку як важливу або зняти позначку"
        type="button"
    >
      <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="30" height="30" :fill="isSelected ? 'gold' : 'none'" viewBox="0 -2 24 24">
